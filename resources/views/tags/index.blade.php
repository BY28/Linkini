...
@section('content')
    <div class="col-sm-offset-4 col-sm-4">
				...
				<tbody>
					@foreach ($tags as $tag)
						<tr>
							...
							<td>{!! link_to_route('tag.show', 'Voir', [$tag->id], ['class' => 'btn btn-success btn-block']) !!}</td>
							<td>{!! link_to_route('tag.edit', 'Modifier', [$tag->id], ['class' => 'btn btn-warning btn-block']) !!}</td>
							<td>
		...
		{!! link_to_route('tag.create', 'Ajouter un utilisateur', [], ['class' => 'btn btn-info pull-right']) !!}
		{!! $links !!}
	</div>
@endsection